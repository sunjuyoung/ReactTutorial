...
var btnDecrease = document.querySelector('#decrease'); //상태에 변화를 주는 액션 , 이름 정의
...
function reducer() {
  ...
  console.log("reducer"); //action.type에 따른 다른 작업을 처리함
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "11274" + '/');
